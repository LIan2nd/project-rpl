                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="content style text-center">
                            ...
                            <p class="tag-text mb-4" data-animation-in="slideInRight">Cari tau lebih banyak tentang kegiatan olahraga disekitar anda!</p>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="content style text-center">
                            ...
                            <p class="tag-text mb-4" data-animation-in="slideInRight" data-duration-in="0.6">Cari tau lebih banyak berita informasi mengenai kegiatan yang akan segera dilaksanakan di sekitar anda</p>
                            <a href="/information" class="btn btn-main btn-white" data-animation-in="slideInRight"
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="content text-center style">
                            ...
                            <p class="tag-text mb-4" data-animation-in="slideInLeft">Jelajahi artikel seputar olahraga dan juga kesehatan terkini</p>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="item">
                                    ...
                                    <p>Senam bersama yang dilakukan oleh para pemuda depok menarik banyak perhatian media massa sehingga banyak orang yang mengikuti acara tersebut dari berbagai kecamatan dari kota Depok</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="item">
                                    ...
                                    <p>Acara lari santai ini dilakukan oleh para <b>Remaja</b> di kota Depok dengan tujuan membuat masyarakat Depok menjadi produktif dikala hari libur mereka.</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="item">
                                    ...
                                    <p>Olahraga menjadi salah satu olahraga ter-favorit di kota Depok karena olahraga tersebut mudah dimainkan dan aturan yang juga tidak sulit untuk di jalani.</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="item">
                                    ...
                                    <p>Turnamen Sepak Bola kali ini di selenggarakan oleh pemerintah kota depok sebagai penyemangat anak muda di kota Depok dalam rangka 17 Agustus.</p>
                                </div>
                            </div>
                        </div>
                    </div>
