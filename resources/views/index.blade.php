...
@section('content')
    ...
    <div class="hero-slider">
        <!-- Slider Item -->
        <div class="slider-item slide1" style="background-image:url({{ asset('user') }}/images/slider/slider-bg-1.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Slide Content Start -->
        ...
        <!-- Slider Item -->
        <div class="slider-item" style="background-image:url({{ asset('user') }}/images/slider/slider-bg-2.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Slide Content Start-->
        ...
        <!-- Slider Item -->
        <div class="slider-item" style="background-image:url({{ asset('user') }}/images/slider/slider-bg-3.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Slide Content Start -->
                                    ...
                                    <div class="icon-box">
                                        <figure>
                                            <a href="services.html"><img loading="lazy"
                                                    src="{{ asset('user') }}/images/resource/1.png"
                        ...
                        <div class="tab-content" id="aboutTab">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/services/service-one.jpg" alt="service-image">
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="contents">
                            ...
                            <div class="service-box tab-pane fade" id="orthopedic">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/services/service-two.jpg" alt="service-image">
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="contents">
                                            <div class="section-title">
                            ...
                            <div class="service-box tab-pane fade" id="sonogram">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/services/service-three.jpg"
                                            alt="service-image">
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="contents">
                            ...
                            <div class="service-box tab-pane fade" id="x-ray">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/services/service-four.jpg"
                                            alt="service-image">
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="contents">
                            ...
                            <div class="service-box tab-pane fade" id="diagnostic">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/services/service-five.jpg"
                                            alt="service-image">
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="contents">
                    ...
                    <div class="items-container">
                        <div class="item">
                            <div class="inner-box">
                                <div class="img_holder">
                                    <a href="service.html">
                                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/1.jpg"
                        ...
                        <div class="item">
                            <div class="inner-box">
                                <div class="img_holder">
                                    <a href="service.html">
                                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/2.jpg"
                                            alt="images" class="img-fluid">
                                    </a>
                                </div>
                                <div class="image-content text-center">
                        ...
                        <div class="item">
                            <div class="inner-box">
                                <div class="img_holder">
                                    <a href="service.html">
                                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/3.jpg"
                                            alt="images" class="img-fluid">
                                    </a>
                                </div>
                                <div class="image-content text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="team-member">
                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-2.jpg" alt="doctor"
                            class="img-fluid">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member">
                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-lab-3.jpg" alt="doctor"
                            class="img-fluid">
                        <div class="contents text-center">
                            <h4>Dr. Marry Lou</h4>
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dignissimos, aspernatur.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member">
                        <img loading="lazy" src="{{ asset('user') }}/images/team/event-2.jpg" alt="doctor"
                            class="img-fluid">
                        <div class="contents text-center">
                    ...
                    <div class="testimonial-carousel">
                        ...
                        <div class="slide-item">
                            <div class="inner-box text-center">
                                <div class="image-box">
                                    <figure>
                                        <img loading="lazy" src="{{ asset('user') }}/images/testimonials/1.png"
                                            alt="">
                                    </figure>
                                </div>
                                <h6>Adam Rose</h6>
                        ...
                        <div class="slide-item">
                            <div class="inner-box text-center">
                                <div class="image-box">
                                    <figure>
                                        <img loading="lazy" src="{{ asset('user') }}/images/testimonials/2.png"
                                            alt="">
                                    </figure>
                                </div>
                                <h6>David Warner</h6>
                        ...
                        <div class="slide-item">
                            <div class="inner-box text-center">
                                <div class="image-box">
                                    <figure>
                                        <img loading="lazy" src="{{ asset('user') }}/images/testimonials/3.png"
                                            alt="">
                                    </figure>
                                </div>
                                <h6>Amy Adams</h6>
