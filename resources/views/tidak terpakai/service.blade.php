...
@section('content')
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="content-block">
                        ...
                        <p>
                            ...
                            Quas eius optio repellendus quasi nisi vitae laboriosam
                            explicabo eligendi sapiente in. Lorem ipsum dolor sit
                            amet, consectetur adipisicing elit. Beatae, dolorum esse
                            tempora id architecto laboriosam.
                        </p>
                        <ul>
                            <li>
                                <i class="fas fa-caret-right"></i>vitae laboriosam
                                explicabo eligendi sapiente
                            </li>
                            <li>
                                <i class="fas fa-caret-right"></i>consectetur
                                adipisicing elit. Beatae
                            </li>
                            <li>
                                <i class="fas fa-caret-right"></i>dolorum esse
                                tempora id architecto
                            </li>
                            <li>
    ...
    <section class="section pt-0">
        <div class="container service-box">
            <div class="row">
                <div class="col-lg-6">
                    <img loading="lazy" class="img-fluid" src="{{ asset('user') }}/images/services/service-one.jpg"
                        alt="service-image" />
                </div>
                <div class="col-lg-6">
                    <div class="contents">
                        ...
                        <ul class="content-list">
                            <li>
                                <i class="far fa-check-circle"></i>Whitening is
                                among the most popular dental
                            </li>
                            <li>
                                <i class="far fa-check-circle"></i>Teeth cleaning is
                    ...
                    <div class="items-container">
                        <div class="item">
                            <div class="inner-box">
                                <div class="img_holder">
                                    <a href="service.html">
                                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/1.jpg" alt="images"
                                            class="img-fluid" />
                                    </a>
                                </div>
                                <div class="image-content text-center">
                                    ...
                                    <p>
                                        ...
                                        adipisicing elit. Suscipit, vero.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="inner-box">
                                <div class="img_holder">
                                    <a href="service.html">
                                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/2.jpg" alt="images"
                                            class="img-fluid" />
                                    </a>
                                </div>
                                <div class="image-content text-center">
                        ...
                        <div class="item">
                            <div class="inner-box">
                                <div class="img_holder">
                                    <a href="service.html">
                                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/3.jpg" alt="images"
                                            class="img-fluid" />
                                    </a>
                                </div>
                                <div class="image-content text-center">
