                        ...
                        <ul class="nav nav-tabs justify-content-center" id="teamTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="doctor-tab" data-toggle="tab" href="#doctor" role="tab"
                                    aria-controls="doctor" aria-selected="true">doctor</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="event-planning-tab" data-toggle="tab" href="#event-planning"
                                    role="tab" aria-controls="event-planning" aria-selected="false">event planning</a>
                            </li>
                            <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="teamTab">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-1.jpg"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-2.jpg"
                                            class="img-fluid" alt="team" />
                                        <h6>Dr. Rag Jhon</h6>
                                        <p>Eye Specialist</p>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-3.jpg"
                                            class="img-fluid" alt="team" />
                        ...
                        <div class="team-members tab-pane fade" id="event-planning">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/event-1.jpg"
                                            class="img-fluid" alt="team" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/event-2.jpg"
                                            class="img-fluid" alt="team" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/event-3.jpg"
                                            class="img-fluid" alt="team" />
                                        <h6>Dr. Tom Moddy</h6>
                                        <p>President</p>
                                    </div>
                        ...
                        <div class="team-members tab-pane fade" id="lab">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-lab-1.jpg"
                                            class="img-fluid" alt="team" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-lab-2.jpg"
                                            class="img-fluid" alt="team" />
                                        <h6>Dr. John Kelly</h6>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="team-person text-center">
                                        <img loading="lazy" src="{{ asset('user') }}/images/team/doctor-lab-3.jpg"
                                            class="img-fluid" alt="team" />
                                        <h6>Dr. Simran Toe</h6>
                                        <p>bone therapy</p>
                                    </div>
