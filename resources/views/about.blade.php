...
@section('content')
    ...
    <section class="story">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img loading="lazy" src="{{ asset('user') }}/images/services/service-one.jpg" class="responsive"
                        alt="story" />
                </div>
                <div class="col-lg-6">
                    <div class="story-content">
                        ...
                        <h5 class="tagline">
                            ...
                            elit. Ipsum, minima. Nemo impedit fuga nostrum expedita
                            sint dicta ullam quam et harum velit saepe"
                        </h5>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Possimus totam ducimus est vero, officiis, placeat
                            optio. Lorem ipsum dolor sit amet consectetur
                            adipisicing elit. Alias aliquam nesciunt fugit optio
                            illum aut. consectetur adipisicing elit. Neque
                            assumenda, est quam perferendis expedita autem?
                        </p>
                        <h6>Mission</h6>
                        <p>
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Nam nihil dolorum beatae consequatur mollitia
                            iure?
                        </p>
                        <h6>Vision</h6>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Assumenda consectetur adipisci, voluptatum dolores
                            nostrum omnis.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <p>
                            ...
                            for high level overv- <br />iews. Iterative approaches
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item">
                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/gallery-01.jpg" class="img-fluid"
                            alt="gallery-image" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item">
                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/gallery-02.jpg" class="img-fluid"
                            alt="gallery-image" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item">
                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/gallery-03.jpg" class="img-fluid"
                            alt="gallery-image" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item">
                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/gallery-04.jpg" class="img-fluid"
                            alt="gallery-image" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item">
                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/gallery-05.jpg" class="img-fluid"
                            alt="gallery-image" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-item">
                        <img loading="lazy" src="{{ asset('user') }}/images/gallery/gallery-06.jpg" class="img-fluid"
                            alt="gallery-image" />
