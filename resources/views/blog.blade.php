                    ...
                    <div class="left-side">
                        <div class="item-holder">
                            ...
                            <div class="content-text">
                                ...
                                <p>
                                    ...
                                    nec, egestas non nisi. Sed porttitor lectus
                                    nibh. Curabitur aliquet quam id dui posuere
                                    blandit. Vestibulum ac diam sit amet quam
                                    vehicula elementum sed sit amet dui.
                                </p>
                                <div class="link-btn">
                                    <a href="/blog-details" class="btn-style-one">read more</a>
                                </div>
                            </div>
                        </div>
                        <div class="item-holder">
                            <div class="image-box">
                                <figure>
                                    <a href="/blog-details"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/blog/6.jpg" alt="" /></a>
                                </figure>
                            </div>
                            <div class="content-text">
                                <a href="/blog-details">
                                    <h4>
                                        To support patients recovery and improve
                                ...
                                <p>
                                    ...
                                    elementum id enim. Donec sollicitudin molestie
                        ...
                        <div class="item-holder">
                            <div class="image-box">
                                <figure>
                                    <a href="/blog-details"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/blog/7.jpg" alt="" /></a>
                                </figure>
                            </div>
                            <div class="content-text">
                                <a href="/blog-details">
                                ...
                                <p>
                                    Sed porttitor lectus nibh. Praesent sapien
                                    massa, convallis a pellentesque nec, egestas non
                                    nisi. Quisque velit nisi, pretium ut lacinia in,
                                    elementum id enim. Praesent sapien massa,
                        ...
                        <div class="item-holder">
                            <div class="image-box">
                                <figure>
                                    <a href="/blog-details"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('user') }}/images/blog/8.jpg" alt="" /></a>
                                </figure>
                            </div>
                            <div class="content-text">
                                <a href="/blog-details">
                                ...
                                <p>
                                    ...
                                    pellentesque nec, egestas non nisi. Vivamus
                    ...
                    <div class="right-side">
                        ...
                        <div class="categorise-menu">
                            ...
                            <ul class="categorise-list">
                                <li>
                                    <a href="blog.html">Alumni <span>(20)</span></a>
                                </li>
                                <li>
                                    <a href="blog.html">Psycology <span>(4)</span></a>
                                </li>
                                <li>
                                    <a href="blog.html">Sonogram <span>(2)</span></a>
                                </li>
                                <li>
                                    <a href="blog.html">x-ray <span>(9)</span></a>
                                </li>
                                <li>
                                    <a href="blog.html">Dental <span>(2)</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="tag-list">
