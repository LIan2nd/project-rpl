    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    All <span class="fw-bold">Users</span>
                                </p>
                            </div>
                        </div>
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible" role="alert">
                <strong><i class='bx bxs-user-check'></i> {{ session('success') }} </strong>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($user->role_id == 2 && $user->contributor == 'false')
                                            <form action="/dashboard/admin/users/validate/{{ $user->id }}"
                                                class="d-inline" method="post">
                                                @csrf
                                                <input type="hidden" name="contributor" value="true">
                                                <button class="btn btn-warning" data-bs-toggle="tooltip"
                                                    data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true"
                                                    title="<i class='bx bx-message-alt-x'></i>&nbsp; <span>Validate this User?</span>"
                                                    onclick="return confirm('Are You sure u wanna validate this user?')"
                                                    type="submit"><span
