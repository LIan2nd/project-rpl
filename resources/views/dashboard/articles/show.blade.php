        ...
        <div class="row mb-5">
            <div class="col-md-8">
                ...
                <a href="/dashboard/articles" class="btn btn-success"><i class='bx bx-left-arrow-alt'></i> Back to All
                    Articles</a>
                <a href="/dashboard/articles/{{ $article->id }}/edit" class="btn btn-warning"><i class="bx bx-edit"></i> Edit
                    Article</a>
                <form action="/dashboard/articles/{{ $article->id }}" class="d-inline" method="post">
                    @method('delete')
                    @csrf
